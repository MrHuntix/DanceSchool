 ...
 <li class="q" id="new" style="float:left;font-size:15px;padding:5px;font-family:Orbitron;">
	...
	<ul style="list-style-type: none;">
		...
		<div id="secans" style="margin-top:100px;top:70px;position:relative;left:-50px;right:0px;overflow:auto;">
			...
			<?php
			$q1="SELECT style FROM users WHERE username='$uname1' ";
			$query_run1=mysql_query($q1);
			$res1=mysql_fetch_assoc($query_run1);
			$style=$res1['style'];
			$q="SELECT * FROM questions WHERE style='$style'";
			$i=1;
				$qr=mysql_query($q);
				...
				<hr color="black">				
				<p>To view all questions</p>
				<a href="ind.php" style="text-decoration: none;"> click here. <a>
		</div>
		<div id="cmt" style="position:relative;top:70px;left:-50px;right:0px;">
			<p>ENTER YOUR ANSWER HERE</p>
			<form action="answer.php" methord="GET">
